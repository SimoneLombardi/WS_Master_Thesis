...
static const _ProximityTaskArray_type_support_symbol_names_t _ProximityTaskArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uc1_robot_perception, msg, ProximityTaskArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uc1_robot_perception, msg, ProximityTaskArray)),
  }
};
...
{
  return &::uc1_robot_perception::msg::rosidl_typesupport_cpp::ProximityTaskArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, uc1_robot_perception, msg, ProximityTaskArray)() {
  return get_message_type_support_handle<uc1_robot_perception::msg::ProximityTaskArray>();
}
