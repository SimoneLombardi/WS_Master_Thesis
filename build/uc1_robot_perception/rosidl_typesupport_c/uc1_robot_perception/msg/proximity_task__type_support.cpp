...
static const _ProximityTask_type_support_symbol_names_t _ProximityTask_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, uc1_robot_perception, msg, ProximityTask)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uc1_robot_perception, msg, ProximityTask)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, uc1_robot_perception, msg, ProximityTask)() {
  return &::uc1_robot_perception::msg::rosidl_typesupport_c::ProximityTask_message_type_support_handle;
}
