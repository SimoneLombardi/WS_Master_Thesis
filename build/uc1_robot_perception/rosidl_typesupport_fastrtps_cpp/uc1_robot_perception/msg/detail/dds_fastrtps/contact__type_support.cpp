...
#include "uc1_robot_perception/msg/detail/contact__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uc1_robot_perception::msg::Contact & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: contact_location
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.contact_location,
    cdr);
  // Member: contact_normal
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.contact_normal,
    cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uc1_robot_perception::msg::Contact & ros_message)
{
  // Member: contact_location
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = uc1_robot_perception::msg::Contact;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const uc1_robot_perception::msg::Contact *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uc1_robot_perception::msg::Contact *>(
    untyped_ros_message);
...
{
  return &uc1_robot_perception::msg::typesupport_fastrtps_cpp::_Contact__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uc1_robot_perception, msg, Contact)() {
  return &uc1_robot_perception::msg::typesupport_fastrtps_cpp::_Contact__handle;
}
