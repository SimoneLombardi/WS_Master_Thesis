...
#include "uc1_robot_perception/msg/detail/contact__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // contact_location, contact_normal
...
using _Contact__ros_msg_type = uc1_robot_perception__msg__Contact;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: contact_location
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->contact_location, cdr))
    {
      return false;
    }
  }

  // Field name: contact_normal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->contact_normal, cdr))
    {
      return false;
    }
  }

  // Field name: contact_intensity
  {
    cdr << ros_message->contact_intensity;
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: contact_location
  {
    ...
    if (!callbacks->cdr_deserialize(
        cdr, &ros_message->contact_location))
    {
      return false;
    }
  }
  ...
  // Field name: contact_normal
  {
    ...
    if (!callbacks->cdr_deserialize(
        cdr, &ros_message->contact_normal))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Vector3(
    &(ros_message->contact_location), current_alignment);
  // field.name contact_normal

  current_alignment += get_serialized_size_geometry_msgs__msg__Vector3(
    &(ros_message->contact_normal), current_alignment);
  // field.name contact_intensity
  {
    size_t item_size = sizeof(ros_message->contact_intensity);
...
static uint32_t _Contact__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_uc1_robot_perception__msg__Contact(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = uc1_robot_perception__msg__Contact;
    is_plain =
      (
...
static size_t _Contact__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_uc1_robot_perception__msg__Contact(
