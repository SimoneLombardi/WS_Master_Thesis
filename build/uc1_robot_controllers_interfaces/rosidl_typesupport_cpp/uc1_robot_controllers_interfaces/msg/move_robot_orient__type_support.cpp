...
static const _MoveRobotOrient_type_support_symbol_names_t _MoveRobotOrient_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uc1_robot_controllers_interfaces, msg, MoveRobotOrient)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uc1_robot_controllers_interfaces, msg, MoveRobotOrient)),
  }
};
...
{
  return &::uc1_robot_controllers_interfaces::msg::rosidl_typesupport_cpp::MoveRobotOrient_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, uc1_robot_controllers_interfaces, msg, MoveRobotOrient)() {
  return get_message_type_support_handle<uc1_robot_controllers_interfaces::msg::MoveRobotOrient>();
}
