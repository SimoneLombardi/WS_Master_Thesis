...
#include "uc1_robot_controllers_interfaces/msg/detail/move_robot_goal__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const uc1_robot_controllers_interfaces::msg::MoveRobotPoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  uc1_robot_controllers_interfaces::msg::MoveRobotPoint &);
size_t get_serialized_size(
  const uc1_robot_controllers_interfaces::msg::MoveRobotPoint &,
  size_t current_alignment);
size_t
max_serialized_size_MoveRobotPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
{
bool cdr_serialize(
  const uc1_robot_controllers_interfaces::msg::MoveRobotOrient &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  uc1_robot_controllers_interfaces::msg::MoveRobotOrient &);
size_t get_serialized_size(
  const uc1_robot_controllers_interfaces::msg::MoveRobotOrient &,
  size_t current_alignment);
size_t
  ...
  size_t current_alignment)
{
  ...
  // Member: translation
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        uc1_robot_controllers_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_MoveRobotPoint(
  ...
  // Member: orientation
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        uc1_robot_controllers_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_MoveRobotOrient(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = uc1_robot_controllers_interfaces::msg::MoveRobotGoal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const uc1_robot_controllers_interfaces::msg::MoveRobotGoal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uc1_robot_controllers_interfaces::msg::MoveRobotGoal *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MoveRobotGoal__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const uc1_robot_controllers_interfaces::msg::MoveRobotGoal *>(
...
static size_t _MoveRobotGoal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MoveRobotGoal(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MoveRobotGoal__callbacks = {
...
static rosidl_message_type_support_t _MoveRobotGoal__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MoveRobotGoal__callbacks,
...
{
  return &uc1_robot_controllers_interfaces::msg::typesupport_fastrtps_cpp::_MoveRobotGoal__handle;
}
