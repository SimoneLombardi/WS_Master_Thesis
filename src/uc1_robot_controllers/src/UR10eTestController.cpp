...
int main(int argc, char *argv[])
{
    ...
    //Eigen::VectorXd qi_kuka = kuka_robot->getJointPositions();
    Eigen::VectorXd qi_ur10 = ur10e_robot->getJointPositions();
    ...
    std::cout << "rb initial joint positions: " << std::endl;
    //std::cout << "Kuka: " << qi_kuka.transpose() << std::endl;
    std::cout << "UR10e: " << qi_ur10.transpose() << std::endl;
