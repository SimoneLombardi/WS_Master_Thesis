    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'uc1_robot_controllers_interfaces.action.MoveRobot_Goal')
            logger.debug(
...
class MoveRobot_Goal(metaclass=Metaclass_MoveRobot_Goal):
    ...
    _fields_and_field_types = {
        ...
        'init_config_code': 'int32',
        'jacobian_type_code': 'int32',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.init_config_code = kwargs.get('init_config_code', int())
        self.jacobian_type_code = kwargs.get('jacobian_type_code', int())
    ...
    def __eq__(self, other):
        ...
        if self.goal != other.goal:
            return False
        if self.init_config_code != other.init_config_code:
            return False
        if self.jacobian_type_code != other.jacobian_type_code:
            return False
        return True
    ...
    @builtins.property
    def init_config_code(self):
        """Message field 'init_config_code'."""
        return self._init_config_code

    @init_config_code.setter
    def init_config_code(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'init_config_code' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'init_config_code' field must be an integer in [-2147483648, 2147483647]"
        self._init_config_code = value

    @builtins.property
    def jacobian_type_code(self):
        """Message field 'jacobian_type_code'."""
        return self._jacobian_type_code

    @jacobian_type_code.setter
    def jacobian_type_code(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'jacobian_type_code' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'jacobian_type_code' field must be an integer in [-2147483648, 2147483647]"
        self._jacobian_type_code = value
...
class Metaclass_MoveRobot_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'uc1_robot_controllers_interfaces.action.MoveRobot_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveRobot_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'uc1_robot_controllers_interfaces.action.MoveRobot_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveRobot_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from uc1_robot_controllers_interfaces.action import MoveRobot
...
class MoveRobot_SendGoal_Request(metaclass=Metaclass_MoveRobot_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'uc1_robot_controllers_interfaces/MoveRobot_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['uc1_robot_controllers_interfaces', 'action'], 'MoveRobot_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from uc1_robot_controllers_interfaces.action._move_robot import MoveRobot_Goal
...
class Metaclass_MoveRobot_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'uc1_robot_controllers_interfaces.action.MoveRobot_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from uc1_robot_controllers_interfaces.action import _move_robot
...
class MoveRobot_SendGoal(metaclass=Metaclass_MoveRobot_SendGoal):
    from uc1_robot_controllers_interfaces.action._move_robot import MoveRobot_SendGoal_Request as Request
    from uc1_robot_controllers_interfaces.action._move_robot import MoveRobot_SendGoal_Response as Response
...
class MoveRobot_GetResult_Response(metaclass=Metaclass_MoveRobot_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'uc1_robot_controllers_interfaces/MoveRobot_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['uc1_robot_controllers_interfaces', 'action'], 'MoveRobot_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from uc1_robot_controllers_interfaces.action._move_robot import MoveRobot_Result
...
class Metaclass_MoveRobot_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'uc1_robot_controllers_interfaces.action.MoveRobot_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveRobot_GetResult(metaclass=Metaclass_MoveRobot_GetResult):
    from uc1_robot_controllers_interfaces.action._move_robot import MoveRobot_GetResult_Request as Request
    from uc1_robot_controllers_interfaces.action._move_robot import MoveRobot_GetResult_Response as Response
...
class Metaclass_MoveRobot_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'uc1_robot_controllers_interfaces.action.MoveRobot_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveRobot_FeedbackMessage(metaclass=Metaclass_MoveRobot_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'uc1_robot_controllers_interfaces/MoveRobot_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['uc1_robot_controllers_interfaces', 'action'], 'MoveRobot_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from uc1_robot_controllers_interfaces.action._move_robot import MoveRobot_Feedback
...
class Metaclass_MoveRobot(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'uc1_robot_controllers_interfaces.action.MoveRobot')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveRobot(metaclass=Metaclass_MoveRobot):
    ...
    from uc1_robot_controllers_interfaces.action._move_robot import MoveRobot_Goal as Goal
    # The result message defined in the action definition.
    from uc1_robot_controllers_interfaces.action._move_robot import MoveRobot_Result as Result
    # The feedback message defined in the action definition.
    from uc1_robot_controllers_interfaces.action._move_robot import MoveRobot_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from uc1_robot_controllers_interfaces.action._move_robot import MoveRobot_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from uc1_robot_controllers_interfaces.action._move_robot import MoveRobot_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from uc1_robot_controllers_interfaces.action._move_robot import MoveRobot_FeedbackMessage as FeedbackMessage
